...
import test.model.sau_regions_config_region
...
#    parser_enum_exception = unittest.TestLoader().loadTestsFromTestCase(test.parser.enum.exception)
    ...
    model_sau_regions_config_region = unittest.TestLoader().loadTestsFromTestCase(test.model.sau_regions_config_region.case)
...
#        parser_enum_exception,
    ...
    #    class_derive_case,
        ...
        model_sau_regions_config_region,
    ]
